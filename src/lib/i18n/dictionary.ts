...
export const en = {
  ...
  // ── Auth modal ───────────────────────────────────────────────────────────
  "auth.createPassTitle": "Create your Explorer Pass",
  "auth.createPassSubtitle": "Unlock tours, save your trip and collect XP",
  "auth.signInTitle": "Welcome back",
  "auth.signInSubtitle": "Sign in to your Explorer Pass",
  "auth.checkEmailTitle": "Check your inbox",
  "auth.checkEmailDesc": "We sent a confirmation link to your email. Click it to activate your Explorer Pass.",
  ...
  "auth.createButton": "Create Explorer Pass",
  "auth.signInButton": "Sign In",
  "auth.googleButton": "Continue with Google",
  "auth.switchToSignIn": "Already have an Explorer Pass? Sign in",
  "auth.switchToSignUp": "New here? Create your free Explorer Pass",
  "auth.gateQuestTitle": "Sign in to start this quest",
  "auth.gateQuestDesc": "Create a free Explorer Pass to scan QR codes, earn XP and collect badges.",
  "auth.gateQuestButton": "Create Explorer Pass",
  "auth.gateTripTitle": "Sign in to see your trips",
  "auth.gateTripDesc": "Your bookings, XP progress and rewards are waiting for you.",
  "auth.gateTripButton": "Sign In",
  "auth.gateBookingHint": "Sign in to book this tour",
...
export const ru: Record<DictionaryKey, string> = {
  ...
  // ── Auth modal ───────────────────────────────────────────────────────────
  "auth.createPassTitle": "Создайте Explorer Pass",
  "auth.createPassSubtitle": "Откройте туры, сохраните поездку и собирайте XP",
  "auth.signInTitle": "С возвращением",
  "auth.signInSubtitle": "Войдите в свой Explorer Pass",
  "auth.checkEmailTitle": "Проверьте почту",
  "auth.checkEmailDesc": "Мы отправили ссылку для подтверждения на ваш email. Нажмите её, чтобы активировать Explorer Pass.",
  "auth.emailLabel": "Email",
  "auth.emailPlaceholder": "your@email.com",
  ...
  "auth.whatsappLabel": "Номер WhatsApp",
  "auth.createButton": "Создать Explorer Pass",
  "auth.signInButton": "Войти",
  "auth.googleButton": "Продолжить через Google",
  "auth.switchToSignIn": "Уже есть Explorer Pass? Войти",
  "auth.switchToSignUp": "Впервые? Создайте бесплатный Explorer Pass",
  "auth.gateQuestTitle": "Войдите, чтобы начать квест",
  "auth.gateQuestDesc": "Создайте бесплатный Explorer Pass для сканирования QR-кодов, получения XP и значков.",
  "auth.gateQuestButton": "Создать Explorer Pass",
  "auth.gateTripTitle": "Войдите, чтобы увидеть поездки",
  "auth.gateTripDesc": "Ваши бронирования, прогресс XP и награды ждут вас.",
  "auth.gateTripButton": "Войти",
  "auth.gateBookingHint": "Войдите, чтобы забронировать тур",
  "auth.signInHeader": "Войти",
