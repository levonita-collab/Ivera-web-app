...
export const en = {
  ...
  "home.step2Desc": "No payment now. Levani confirms availability within 2 hours.",
  "home.step3Title": "Complete missions during the tour",
  "home.step3Desc": "Scan QR codes, taste, observe, and discover at each stop.",
  "home.step4Title": "Earn XP, badges and rewards",
  "home.step4Desc": "Track your progress and climb the leaderboard.",
  ...
  "quest.demoNotePrefix": "✦ Tap",
  "quest.demoNoteSuffix": "to simulate completing a mission. In the field, you scan the real QR codes posted at each location.",
...
export const ru: Record<DictionaryKey, string> = {
  ...
  "home.step2Desc": "Оплата не требуется сейчас. Левани подтвердит доступность в течение 2 часов.",
  "home.step3Title": "Выполняйте задания во время тура",
  "home.step3Desc": "Сканируйте QR-коды, пробуйте, наблюдайте и открывайте новое на каждой остановке.",
  "home.step4Title": "Получайте опыт, значки и награды",
  "home.step4Desc": "Следите за прогрессом и поднимайтесь в рейтинге.",
  ...
  "quest.demoNotePrefix": "✦ Нажмите",
  "quest.demoNoteSuffix": "чтобы симулировать выполнение задания. В туре вы сканируете настоящие QR-коды на каждой точке.",
  ...
  "quest.demoScan": "Демо-сканирование ✦",
